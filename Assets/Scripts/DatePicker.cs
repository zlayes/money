...
namespace Money
{
    public class DatePicker : MonoBehaviour
    {
        ...
        [SerializeField] private StringData selectedDateData;
        [SerializeField] private StringData todayDateData;
        ...
        public DateTime SelectedDate
        {
            ...
            private set
            {
                ...
                selectedDateData.Value = m_SelectedDate.ToString(DateFormat);
                todayDateData.Value = DateTime.Now.ToString(DateFormat);

                ExchangeRatesManager.current.SwitchCurrencyByDate(selectedDateData.Value ,todayDateData.Value);
